...
const LAWYER_PHOTO = "https://cdn.poehali.dev/projects/def78d0b-7610-4e89-a200-4a914aa8cb3b/bucket/afbf0a47-8821-49a8-a585-39b873485886.jpg";
          ...
          <div className="grid lg:grid-cols-2 gap-16">
            <div>
              ...
              <div className="space-y-8">
                {[
                  { year: "2006–2010", role: "Помощник следователя", org: "Следственный комитет РФ", desc: "Участие в расследовании более 200 уголовных дел различных категорий." },
                  { year: "2010–2016", role: "Адвокат-защитник", org: "Московская коллегия адвокатов", desc: "Специализация на делах о преступлениях против личности и экономических преступлениях." },
                  { year: "2016–н.в.", role: "Частная практика", org: "Адвокатский кабинет", desc: "Независимая практика. Индивидуальный подход к каждому делу. Работа по всей стране." },
                ].map((item, i) => (
